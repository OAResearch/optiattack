...
from pymoo.algorithms.soo.nonconvex.ga import comp_by_cv_and_fitness, GA
...
class DEAlgorithm(PyMooAlgorithm):
    ...
    def get_type(self):
        ...
        return ConfigParser.Algorithms.DE
    ...
    def infill(self):
        """Request the infill solutions from the algorithm."""
