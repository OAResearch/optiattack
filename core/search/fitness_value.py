...
class FitnessValue:
    ...
    def __init__(self, value: float, predictions: list, execution_time_ms: int = 0):
    ...
    def copy(self):
        """Returns a copy of the FitnessValue."""
        return FitnessValue(self.value, self.predictions, self.execution_time_ms)
